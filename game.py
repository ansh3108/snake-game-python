...
class Snake:
    ...
    def draw(self, screen):
        pygame.draw.rect(screen, pygame.Color("green"), (self.segments[0].x, self.segments[0].y, SNAKE_SIZE, SNAKE_SIZE), 0)
        counter = 1
        while counter < len(self.segments):
            if self.segments[counter].color == "NULL":
                counter += 1
                continue
            pygame.draw.rect(screen, pygame.Color("yellow"), (self.segments[counter].x, self.segments[counter].y, SNAKE_SIZE, SNAKE_SIZE), 0)
            counter += 1
